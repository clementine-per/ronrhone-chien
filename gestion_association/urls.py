...
urlpatterns = [
    ...
    # Orders
    path("order/update/<int:pk>/", order.UpdateOrder.as_view(), name="update_order"),
    path("order/create_animal/<int:pk>/", order.create_order_from_animal,
         name="create_order_animal"),
    # Paramétrages
